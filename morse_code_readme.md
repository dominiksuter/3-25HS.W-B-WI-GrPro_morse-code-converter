...
| Name       | Contribution                                  |
|------------|-----------------------------------------------|
| Student A  | Implemented text-to-Morse encoding            |
| Student B  | Implemented Morse-to-text decoding & error handling |
| Student C  | File handling and saving conversion history   |
...
- Work only within your copy — do not push to the original template  
- Commit regularly to track your progress  
